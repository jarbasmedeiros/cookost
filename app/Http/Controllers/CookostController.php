...
class CookostController extends Controller
{
    /**
    ...
    public function cookost(Request $request)
    {
        ...
        {
            case 'PlayerSuicide':
                $times = Cookost::where('type',$type)->where('server_uid',$server_uid)->where('playerone',$playerone)->count();
                ++$times;
            ...
            case 'PlayerHit':
                ...
                $times = Cookost::where('type',$type)->where('server_uid',$server_uid)->where('playerone',$playerone)->where('playertwo',$playertwo)->count();
                $times2 = Cookost::where('type',$type)->where('server_uid',$server_uid)->where('playerone',$playertwo)->where('playertwo',$playerone)->count();
                ++$times;
                $response .= $playertwo."\n";
